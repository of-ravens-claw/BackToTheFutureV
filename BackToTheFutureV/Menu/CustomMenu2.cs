...
namespace BackToTheFutureV
{
    internal class CustomMenu2 : BTTFVMenu
    {
        ...
        {
            if (!Game.IsControlJustPressed(Control.PhoneLeft) && !Game.IsControlJustPressed(Control.PhoneRight)) return;
        ...
        public override void Menu_Shown(object sender, EventArgs e)
        {
            ...
            if (FusionUtils.PlayerVehicle.IsTimeMachine())
            {
                ...
                _hoverUnderbody.Enabled = CurrentTimeMachine.Vehicle.Model == "deluxo" || CurrentTimeMachine.Vehicle.Model == ModelHandler.DMC12;
        ...
        public override void Menu_OnItemActivated(NativeItem sender, EventArgs e)
        {
            ...
            {
                string name = Game.GetUserInput(WindowTitle.EnterMessage20, "", 20);
                ...
                CurrentTimeMachine.Clone().Save(name);
            }
        }
